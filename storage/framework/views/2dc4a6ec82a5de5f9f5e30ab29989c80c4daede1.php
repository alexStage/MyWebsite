    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-light bg-blue">
        ...
        <div class="collapse navbar-collapse navbar-header" id="navbarTogglerDemo01">
            <ul class="nav navbar-nav mr-auto">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if(Auth::user()->isFamily()): ?>
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" target="_self" href="<?php echo e(route('photos.search')); ?>">Toutes les photos</a>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li>
                    <a class="nav-link" target="_self" href="<?php echo e(route('admin')); ?>">
                        <?php echo e(__('Admin')); ?>
                ...
                <li>
                    <a class="nav-link" target="_self" href="<?php echo e(route('logout')); ?>"
...
<?php /**PATH C:\Users\dhaen\Documents\programmation\MyWebsite\resources\views/layouts/layout.blade.php ENDPATH**/ ?>