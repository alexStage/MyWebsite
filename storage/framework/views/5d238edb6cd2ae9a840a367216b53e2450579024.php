        ...
        <div class="collapse navbar-collapse navbar-header" id="navbarTogglerDemo01">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" target="_self" href="<?php echo e(route('accueil')); ?>">accueil</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" target="_self" href="<?php echo e(route('voyages.index')); ?>">voyages</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" target="_self" href="<?php echo e(route('voyages.create')); ?>">Créer un voyage</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <form id="logout-form" target="_self" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
                </form>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('users.show', Auth::user()->id)); ?>">
                            <?php echo e(__('modifier votre profile')); ?>
...
<?php /**PATH /var/www/MyWebsite/resources/views/layouts/layout.blade.php ENDPATH**/ ?>