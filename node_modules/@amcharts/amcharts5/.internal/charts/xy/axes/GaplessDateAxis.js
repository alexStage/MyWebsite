    ...
    Object.defineProperty(GaplessDateAxis.prototype, "_prepareAxisItems", {
        ...
        value: function () {
            ...
            if ($type.isNumber(startTime) && $type.isNumber(endTime)) {
                ...
                var selectedItems_1 = [];
                var value = $time.round(new Date(this.getPrivate("min", 0)), gridInterval_1.timeUnit, gridInterval_1.count, this._root.locale.firstDayOfWeek, this._root.utc, undefined, this._root.timezone).getTime() - intervalDuration_1;
